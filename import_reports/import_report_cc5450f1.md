...
- **File:** `import_20260616_022323.csv`
- **Job ID:** `cc5450f1-f451-4731-9cb5-df2a7931feba`
- **Status:** completed
- **Created:** 2026-06-16T02:23:23.864810+00:00
- **Completed:** 2026-06-16T02:23:45.335668+00:00
...
|---|------:|------|----------|---------|-------------------|
| 1 | **20** | `unknown_participant` | **ERROR** | Row 1: Participant 'Meera' does not match any group member | 20/0/0 |
| _Rows: 1, 2, 3, 6, 7, 9, 10, 11, 12, 14, ... (+10 more)_ | | | | | |
| 2 | **12** | `unknown_participant` | **ERROR** | Row 4: Payer 'Dev' does not match any group member | 12/0/0 |
| _Rows: 4, 5, 7, 16, 19, 22, 25, 29, 31, 37, ... (+2 more)_ | | | | | |
| 3 | **11** | `unknown_participant` | **ERROR** | Row 4: Participant 'Dev' does not match any group member | 11/0/0 |
| _Rows: 4, 5, 18, 19, 20, 21, 22, 23, 24, 25, ... (+1 more)_ | | | | | |
| 4 | **5** | `unknown_participant` | **ERROR** | Row 38: Participant 'Sam' does not match any group member | 5/0/0 |
| _Rows: 38, 39, 40, 41, 42_ | | | | | |
| 5 | **4** | `currency_mismatch_group` | **WARNING** | Row 19: Currency 'USD' differs from group default 'INR' | 4/0/0 |
| _Rows: 19, 20, 22, 25_ | | | | | |
| 6 | **3** | `ambiguous_date` | **WARNING** | Row 22: Date '11/03/2026' is ambiguous (DD/MM vs MM/DD) | 3/0/0 |
| _Rows: 22, 23, 24_ | | | | | |
| 7 | **2** | `invalid_percentages` | **ERROR** | Row 14: Percentages sum to 110%, must be 100% | 2/0/0 |
| _Rows: 14, 31_ | | | | | |
| 8 | **2** | `settlement_as_expense` | **WARNING** | Row 13: 'Rohan paid Aisha back' looks like a settlement, not an expense | 2/0/0 |
| _Rows: 13, 37_ | | | | | |
| 9 | **2** | `ambiguous_date` | **WARNING** | Row 20: Date '10/03/2026' is ambiguous (DD/MM vs MM/DD) | 2/0/0 |
| _Rows: 20, 21_ | | | | | |
| 10 | **1** | `missing_payer` | **ERROR** | Row 12: Payer (paid_by) is empty | 1/0/0 |
| _Rows: 12_ | | | | | |
| 11 | **1** | `invalid_split_type` | **ERROR** | Row 13: Split type is empty | 1/0/0 |
| _Rows: 13_ | | | | | |
| 12 | **1** | `unknown_participant` | **ERROR** | Row 22: Participant 'Dev's friend Kabir' does not match any group member | 1/0/0 |
| _Rows: 22_ | | | | | |
| 13 | **1** | `invalid_currency` | **ERROR** | Row 27: Currency is empty | 1/0/0 |
| _Rows: 27_ | | | | | |
| 14 | **1** | `ambiguous_date` | **WARNING** | Row 15: Date '01/03/2026' is ambiguous (DD/MM vs MM/DD) | 1/0/0 |
| _Rows: 15_ | | | | | |
| 15 | **1** | `ambiguous_date` | **WARNING** | Row 17: Date '05/03/2026' is ambiguous (DD/MM vs MM/DD) | 1/0/0 |
| _Rows: 17_ | | | | | |
| 16 | **1** | `ambiguous_date` | **WARNING** | Row 18: Date '08/03/2026' is ambiguous (DD/MM vs MM/DD) | 1/0/0 |
| _Rows: 18_ | | | | | |
| 17 | **1** | `ambiguous_date` | **WARNING** | Row 19: Date '09/03/2026' is ambiguous (DD/MM vs MM/DD) | 1/0/0 |
| _Rows: 19_ | | | | | |
| 18 | **1** | `ambiguous_date` | **WARNING** | Row 25: Date '12/03/2026' is ambiguous (DD/MM vs MM/DD) | 1/0/0 |
| _Rows: 25_ | | | | | |
| 19 | **1** | `negative_amount` | **WARNING** | Row 25: Amount is negative (-30) - possible refund | 1/0/0 |
| _Rows: 25_ | | | | | |
| 20 | **1** | `zero_amount` | **WARNING** | Row 30: Amount is zero | 1/0/0 |
| _Rows: 30_ | | | | | |
| 21 | **1** | `ambiguous_date` | **WARNING** | Row 33: Date '04/05/2026' is ambiguous (DD/MM vs MM/DD) | 1/0/0 |
| _Rows: 33_ | | | | | |
| 22 | **1** | `split_details_format_mismatch` | **WARNING** | Row 41: Split type is 'equal' but split_details contain values | 1/0/0 |
| _Rows: 41_ | | | | | |

## Detailed Anomaly Breakdown

### 1. unknown_participant (20 occurrences)
...
### 2. unknown_participant (12 occurrences)
...
### 3. unknown_participant (11 occurrences)
...
### 4. unknown_participant (5 occurrences)
...
### 5. currency_mismatch_group (4 occurrences)
...
### 6. ambiguous_date (3 occurrences)
...
### 7. invalid_percentages (2 occurrences)
...
### 8. settlement_as_expense (2 occurrences)
...
### 9. ambiguous_date (2 occurrences)
...
### 11. invalid_split_type (1 occurrence)
...
### 12. unknown_participant (1 occurrence)
...
### 13. invalid_currency (1 occurrence)
...
### 14. ambiguous_date (1 occurrence)
...
### 21. ambiguous_date (1 occurrence)
...
### 22. split_details_format_mismatch (1 occurrence)
...
_Report generated at 2026-06-16T02:23:53.885799_
